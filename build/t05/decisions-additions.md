...
## Part D · 2026-08-08 補檔：獨立 verifier 具名之未落正典缺口（3 條裁示＋1 條登記）

> 起因：獨立 verifier 於 T-26 第四輪站 2 缺口審具名 finding（對應 `build/t26/station2-gap-review.md` H-2 一類——`SC-DEC-ROUTE-001` 之後的沙盒 CLI executor 憑證供應前提未落正典）。本節補上該裁示，並一併補上同輪另兩項當日已裁示但未落檔的事項。類別 token 延續既有慣例（CLI 延續 SC-DEC-CLI-001 的脈絡；ANCHOR／NOOP 為本節首用新類別）。本節條目同屬 draft，走 §8 PR 路徑生效。
